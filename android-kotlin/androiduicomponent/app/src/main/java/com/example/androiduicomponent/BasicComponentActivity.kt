...
import com.example.androiduicomponent.databinding.BasicComponentsActivityBinding

class BasicComponentActivity : AppCompatActivity() {
    private lateinit var binding: BasicComponentsActivityBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = BasicComponentsActivityBinding.inflate(layoutInflater)
