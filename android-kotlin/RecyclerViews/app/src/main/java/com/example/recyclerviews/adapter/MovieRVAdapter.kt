...
class MovieRVAdapter (
    ...
    override fun onBindViewHolder(
        ...
        holder.moreButton.setOnClickListener { view ->
            ...
            popupMenu.menuInflater.inflate(R.menu.more_option_menu,popupMenu.menu)

            popupMenu.setOnMenuItemClickListener { item ->
                when(item.itemId){
                    R.id.positive_suggestion -> {
                        Log.e("suggesiton","positive")
                        true
                    }
                    R.id.negative_suggestion ->{
                        Log.e("suggestion","negative")
                        true
                    }
                    else -> false
                }
